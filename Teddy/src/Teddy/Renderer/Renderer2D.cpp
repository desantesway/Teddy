...
namespace Teddy 
{
	...
	{
		DrawString({component.TextString, component.Color, 
			component.Kerning, component.LineSpacing, //component.BackgroundColor, 
			component.OutlineColor, component.OutlineWidth }, 
