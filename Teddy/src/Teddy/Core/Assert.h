...
#define TED_INTERNAL_ASSERT_NO_MSG(type, check) TED_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", TED_STRINGIFY_MACRO(check), ::Teddy::Assert::CurrentFileName(__FILE__), __LINE__)
